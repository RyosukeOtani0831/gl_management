<html>
  ...
  <body class="login_body">
    ...
    <div class="login_bg">
      <!-- ログアウトボタン -->
      <a href="{{ route('delivery_logout') }}" class="btn btn-secondary logout-btn">ログアウト</a>
      ...
      <form role="form" class="form-inline login_delivery_form input-group" enctype="multipart/form-data" method="post" action="{{ action('DeliveryController@deliveryMessage')}}">
      @csrf
